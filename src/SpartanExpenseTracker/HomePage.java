    ...
    private void ExpenseButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExpenseButtonActionPerformed
                ...
                if(x == 2)
           {
                    ...
                    if(CountingClasses == 1)
                    {
                        ...
                        int ConfirmOrNot = JOptionPane.showOptionDialog(null,"Do you want to confirm your selection of One Class for "+ClassName1 
                           +"?","Confirm",JOptionPane.DEFAULT_OPTION,
                        JOptionPane.QUESTION_MESSAGE, null, YesOrNo, YesOrNo[0] );
                        ...
                        if(CountingClasses == 2)
                    {
                        ...
                        int ConfirmOrNot = JOptionPane.showOptionDialog(null,"Do you want to confimr your selection of One Class for "
                        ...
                        if(CountingClasses == 3)
                    {
                        ...
                        int ConfirmOrNot = JOptionPane.showOptionDialog(null,"Do you wan't to confirm your selection of One Class for "
